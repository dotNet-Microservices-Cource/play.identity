...
namespace Play.Identity.Service.HostedServices
{
  public class IdentitySeedHostedService : IHostedService
  {
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
      ...
      await CrateRoleIfNotExistsAsync(Roles.Admin, roleManager);
      await CrateRoleIfNotExistsAsync(Roles.Player, roleManager);
    ...
    private static async Task CrateRoleIfNotExistsAsync(string role, RoleManager<ApplicationRole> roleManager)
    {
